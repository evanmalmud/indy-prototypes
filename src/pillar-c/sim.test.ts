 ...
 * space during authoring, then pasted here as a literal sequence. They are
 * regression tests on the economy: change a price in COST_POINTS or a row in
 * the shared table and the numbers here move, loudly.
 */
...
const PROOFS: Readonly<Record<string, RoomProof>> = {
  c1: {
    escape: {
